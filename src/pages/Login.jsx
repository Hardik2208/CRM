    ...
    <div className="flex h-screen">
      ...
      <div className="w-1/2 bg-blue-600 text-white flex flex-col justify-center px-16 relative z-0">
        ...
        <div className="absolute top-6 left-6 flex items-center space-x-2 z-10">
          <h1 className="text-2xl font-bold">MyShopDesk</h1>
        </div>
        <div className="mt-20">
          ...
          <ul className="space-y-4 z-10">
            <li className="flex items-center">
              <span className="mx-2 bg-[#5182EF] rounded-[25px] w-[50px] h-[50px] flex justify-center items-center"><Cpu/></span>
              Inventory tracking with real-time updates
            </li>
            <li className="flex items-center">
              <span className="mx-2 bg-[#5182EF] rounded-[25px] w-[50px] h-[50px] flex justify-center items-center"><HardDrive/></span>
              Detailed sales analytics and reporting
            </li>
            <li className="flex items-center">
              <span className="mx-2 bg-[#5182EF] rounded-[25px] w-[50px] h-[50px] flex justify-center items-center"><Cable/></span>
