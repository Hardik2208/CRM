...
const Sidebar = () => {
  ...
  return (
    <div className="bg-[#222831] h-[91vh] text-white shadow-md z-50 m-[0] w-[8%]">
      <ul className="flex flex-col justify-around py-2">
        <li
          onClick={() => navigate("/")}
          className="flex mb-[2vh] gap-4 items-center cursor-pointer p-2 hover:text-blue-400 transition duration-300"
        >
        ...
        <li
          ...
          className="flex mb-[2vh] gap-4 items-center cursor-pointer p-2 relative hover:text-blue-400 transition duration-300"
        >
        ...
        <li className="flex mb-[2vh] gap-4 items-center cursor-pointer p-2 hover:text-red-400 transition duration-300">
